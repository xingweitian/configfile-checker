 ...
 *
 * <p>Tests appear as Java files in the {@code tests/config} folder. To add a new test case, create
...
public class ConfigTest extends CheckerFrameworkPerDirectoryTest {
    public ConfigTest(List<File> testFiles) {
        super(testFiles, ConfigChecker.class, "config", "-Anomsgtext", "-Astubs=stubs/", "-nowarn");
    }
