...
class ConfigFileReadTest {
    ...
    void b() throws IOException{
        ...
        InputStream inputStream = getClass().getClassLoader().getResourceAsStream(propFile);
        prop.load(inputStream);
        @ConfigFilePropertyValue("localhost") String host = prop.getProperty("HOST", "127.0.0.1");
    }
    ...
    void c() throws IOException{
        ...
        InputStream inputStream = getClass().getClassLoader().getResourceAsStream(propFile);
        prop.load(inputStream);
        @ConfigFilePropertyValue("default value") String host = prop.getProperty("NOSUCHKEY", "default value");
    }
}
